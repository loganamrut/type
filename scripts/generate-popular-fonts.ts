...
import { TYPEFACES } from '../src/lib/fonts-data';
import { Typeface } from '../src/lib/types';

// The 200+ most popular fonts widely used across online font generators, Google Fonts, and design tools:
const NEW_POPULAR_FONTS: Typeface[] = [
  // ==========================================
  // SANS-SERIF & MODERN GROTESQUE (45 fonts)
  // ==========================================
  {
    id: 'open-sans',
    name: 'Open Sans',
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'neutral', 'screen-optimized'],
    weights: [300, 400, 500, 600, 700, 800],
    styles: ['normal', 'italic'],
    isVariable: true,
    variableAxes: [{ tag: 'wght', name: 'Weight', min: 300, max: 800, default: 400, step: 1 }],
    source: 'google-fonts',
    ...
    tags: ['humanist', 'clean', 'legible', 'versatile', 'web'],
    popularity: 99,
    suggestedPairings: ['playfair-display', 'lora', 'merriweather'],
    useCases: ['website', 'ui', 'editorial', 'resume'],
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'warm', 'corporate'],
    ...
    tags: ['corporate', 'warm', 'friendly', 'business'],
    popularity: 98,
    suggestedPairings: ['merriweather', 'playfair-display'],
    useCases: ['website', 'presentation', 'branding', 'resume'],
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['condensed', 'geometric', 'headline'],
    weights: [200, 300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: true,
    variableAxes: [{ tag: 'wght', name: 'Weight', min: 200, max: 700, default: 400, step: 1 }],
    source: 'google-fonts',
    license: 'SIL Open Font License 1.1',
    licenseUrl: 'https://scripts.sil.org/OFL',
    author: 'Vernon Adams',
    ...
    tags: ['condensed', 'headline', 'impact', 'poster'],
    popularity: 97,
    suggestedPairings: ['lora', 'eb-garamond'],
    useCases: ['poster', 'website', 'logo', 'social-media'],
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'ui', 'technical'],
    ...
    tags: ['clean', 'adobe', 'ui', 'modern'],
    popularity: 95,
    suggestedPairings: ['source-serif-4', 'merriweather'],
    useCases: ['ui', 'website', 'code', 'presentation'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['rounded', 'friendly', 'playful'],
    weights: [200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['rounded', 'friendly', 'mobile', 'soft'],
    popularity: 96,
    suggestedPairings: ['playfair-display', 'alegreya'],
    useCases: ['ui', 'website', 'branding', 'social-media'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'neutral', 'ui'],
    weights: [200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['ui', 'clean', 'versatile', 'modern'],
    popularity: 94,
    suggestedPairings: ['cormorant-garamond', 'spectral'],
    useCases: ['ui', 'website', 'editorial', 'resume'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'elegant', 'display'],
    ...
    tags: ['elegant', 'geometric', 'fashion', 'clean'],
    popularity: 96,
    suggestedPairings: ['merriweather', 'lora'],
    useCases: ['branding', 'website', 'presentation', 'poster'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'tech', 'distinct'],
    ...
    tags: ['tech', 'linux', 'modern', 'distinctive'],
    popularity: 91,
    suggestedPairings: ['ubuntu-mono', 'lora'],
    useCases: ['tech', 'ui', 'website'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'rounded', 'friendly'],
    ...
    tags: ['rounded', 'bold', 'friendly', 'modern'],
    popularity: 95,
    suggestedPairings: ['karla', 'merriweather'],
    useCases: ['logo', 'ui', 'social-media', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['grotesque', 'industrial', 'california'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['industrial', 'signage', 'clean', 'retro'],
    popularity: 93,
    suggestedPairings: ['fraunces', 'lora'],
    useCases: ['poster', 'website', 'branding', 'ui'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['condensed', 'industrial', 'headline'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['condensed', 'headline', 'poster'],
    popularity: 91,
    suggestedPairings: ['barlow', 'merriweather'],
    useCases: ['poster', 'logo', 'social-media'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['rounded', 'geometric', 'aesthetic'],
    ...
    tags: ['rounded', 'aesthetic', 'friendly', 'cute'],
    popularity: 94,
    suggestedPairings: ['eb-garamond', 'lora'],
    useCases: ['branding', 'social-media', 'website', 'logo'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['neo-grotesque', 'neutral', 'screen-optimized'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['neutral', 'clean', 'swiss', 'ui'],
    popularity: 92,
    suggestedPairings: ['playfair-display', 'spectral'],
    useCases: ['ui', 'website', 'code'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['highway', 'grotesque', 'tech'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['highway', 'redhat', 'tech', 'bold'],
    popularity: 88,
    suggestedPairings: ['overpass-mono', 'lora'],
    useCases: ['ui', 'website', 'tech', 'poster'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['tech', 'geometric', 'italian'],
    ...
    tags: ['tech', 'cyberpunk', 'engineering', 'gaming'],
    popularity: 90,
    suggestedPairings: ['roboto-mono', 'bitter'],
    useCases: ['tech', 'gaming', 'ui', 'website'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'clean', 'legible'],
    ...
    tags: ['clean', 'editorial', 'modern', 'humanist'],
    popularity: 89,
    suggestedPairings: ['playfair-display', 'newsreader'],
    useCases: ['website', 'editorial', 'ui'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['neutral', 'governmental', 'accessible'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['government', 'accessibility', 'neutral', 'clean'],
    popularity: 91,
    suggestedPairings: ['merriweather', 'cormorant-garamond'],
    useCases: ['website', 'ui', 'presentation', 'resume'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'friendly', 'modern'],
    weights: [300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['modern', 'friendly', 'ui', 'geometric'],
    popularity: 92,
    suggestedPairings: ['fraunces', 'newsreader'],
    useCases: ['ui', 'website', 'branding', 'presentation'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'minimal', 'modern'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['architectural', 'minimal', 'geometric', 'modern'],
    popularity: 93,
    suggestedPairings: ['bodoni-moda', 'playfair-display'],
    useCases: ['branding', 'website', 'logo', 'ui'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['dyslexia-friendly', 'readable', 'educational'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['accessibility', 'educational', 'reading', 'clean'],
    popularity: 90,
    suggestedPairings: ['merriweather', 'lora'],
    useCases: ['website', 'editorial', 'ui', 'presentation'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['expanded', 'readable', 'modern'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['readable', 'ui', 'modern', 'clean'],
    popularity: 88,
    suggestedPairings: ['newsreader', 'spectral'],
    useCases: ['ui', 'website', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['neo-grotesque', 'contemporary', 'tech'],
    ...
    tags: ['design-system', 'tech', 'modern', 'minimal'],
    popularity: 91,
    suggestedPairings: ['instrument-serif', 'playfair-display'],
    useCases: ['ui', 'website', 'branding', 'tech'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'scandinavian', 'modern'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['scandinavian', 'clean', 'geometric', 'nordic'],
    popularity: 87,
    suggestedPairings: ['cormorant-garamond', 'lora'],
    useCases: ['website', 'branding', 'presentation'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'cyber', 'ui'],
    ...
    tags: ['futuristic', 'crypto', 'fintech', 'modern'],
    popularity: 89,
    suggestedPairings: ['jetbrains-mono', 'syne'],
    useCases: ['tech', 'gaming', 'website', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['tech', 'ui', 'creative'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['3d', 'ui', 'tech', 'clean'],
    popularity: 86,
    suggestedPairings: ['space-mono', 'unbounded'],
    useCases: ['ui', 'tech', 'website'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['contemporary', 'neo-grotesque', 'multilingual'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['tech', 'vietnamese', 'clean', 'international'],
    popularity: 88,
    suggestedPairings: ['playfair-display', 'lora'],
    useCases: ['website', 'ui', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'enterprise', 'brand'],
    weights: [300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['enterprise', 'redhat', 'headline', 'tech'],
    popularity: 89,
    suggestedPairings: ['red-hat-text', 'red-hat-mono'],
    useCases: ['branding', 'presentation', 'website'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['body', 'legible', 'enterprise'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['reading', 'enterprise', 'ui', 'documentation'],
    popularity: 87,
    suggestedPairings: ['red-hat-display', 'merriweather'],
    useCases: ['website', 'editorial', 'ui'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'futura-inspired', 'bauhaus'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['bauhaus', 'futura', 'geometric', 'retro'],
    popularity: 93,
    suggestedPairings: ['playfair-display', 'cormorant-garamond'],
    useCases: ['branding', 'logo', 'website', 'poster'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'clean', 'modern'],
    weights: [400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['humanist', 'clean', 'friendly', 'editorial'],
    popularity: 89,
    suggestedPairings: ['bitter', 'lora'],
    useCases: ['website', 'ui', 'presentation'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['grotesque', 'nineteenth-century', 'bold'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['grotesque', 'bold', 'editorial', 'poster'],
    popularity: 89,
    suggestedPairings: ['spectral', 'newsreader'],
    useCases: ['editorial', 'poster', 'website'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['condensed', 'headline', 'grotesque'],
    weights: [400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['condensed', 'headline', 'compact'],
    popularity: 88,
    suggestedPairings: ['lora', 'merriweather'],
    useCases: ['editorial', 'poster', 'website'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['compact', 'screen-optimized', 'ui'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['ui', 'compact', 'modern', 'clean'],
    popularity: 91,
    suggestedPairings: ['playfair-display', 'merriweather'],
    useCases: ['ui', 'website', 'tech'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'moldova', 'modern'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['geometric', 'modern', 'clean', 'open'],
    popularity: 87,
    suggestedPairings: ['cormorant-garamond', 'bitter'],
    useCases: ['website', 'ui', 'presentation'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['grotesque', 'headline', 'contemporary'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['grotesque', 'editorial', 'contemporary', 'strong'],
    popularity: 89,
    suggestedPairings: ['spectral', 'cardo'],
    useCases: ['editorial', 'poster', 'website', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['neo-grotesque', 'geometric', 'display'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['neo-grotesque', 'versatile', 'modern', 'clean'],
    popularity: 88,
    suggestedPairings: ['newsreader', 'merriweather'],
    useCases: ['branding', 'website', 'ui', 'logo'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['grotesque', 'quirky', 'humanist'],
    weights: [200, 300, 400, 500, 600, 700, 800],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['quirky', 'friendly', 'editorial', 'modern'],
    popularity: 93,
    suggestedPairings: ['cormorant-garamond', 'lora'],
    useCases: ['website', 'branding', 'editorial'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['rounded', 'modern', 'flowing'],
    ...
    tags: ['flowing', 'rounded', 'modern', 'tech'],
    popularity: 89,
    suggestedPairings: ['lora', 'playfair-display'],
    useCases: ['logo', 'branding', 'website'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['rounded', 'omni-width', 'screen'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['smart', 'ui', 'rounded', 'clean'],
    popularity: 88,
    suggestedPairings: ['merriweather', 'bitter'],
    useCases: ['ui', 'website', 'presentation'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'multilingual', 'modern'],
    weights: [200, 300, 400, 500, 600, 700, 800],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['devanagari', 'humanist', 'international', 'clean'],
    popularity: 91,
    suggestedPairings: ['lora', 'eb-garamond'],
    useCases: ['website', 'editorial', 'ui'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'national', 'clean'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['cyrillic', 'humanist', 'universal', 'reliable'],
    popularity: 92,
    suggestedPairings: ['pt-serif', 'lora'],
    useCases: ['editorial', 'website', 'presentation'],
    fallback: 'system-ui, sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'mozilla', 'tech'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['mozilla', 'spiekermann', 'tech', 'ui'],
    popularity: 93,
    suggestedPairings: ['fira-code', 'merriweather'],
    useCases: ['tech', 'ui', 'website', 'code'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['humanist', 'tamil', 'refined'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['tamil', 'humanist', 'clean', 'multilingual'],
    popularity: 88,
    suggestedPairings: ['playfair-display', 'spectral'],
    useCases: ['website', 'editorial', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['wayfinding', 'signage', 'clear'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['signage', 'wayfinding', 'clear', 'legible'],
    popularity: 89,
    suggestedPairings: ['merriweather', 'playfair-display'],
    useCases: ['poster', 'website', 'ui'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    tags: ['geometric', 'circle', 'modern', 'clean'],
    popularity: 90,
    suggestedPairings: ['playfair-display', 'lora'],
    useCases: ['branding', 'website', 'logo', 'presentation'],
    fallback: 'sans-serif',
    googleFontQuery: 'Questrial&display=swap',
  },

  // ==========================================
  // SERIF, EDITORIAL & CLASSICAL (40 fonts)
  // ==========================================
  {
    id: 'pt-serif',
    name: 'PT Serif',
    ...
    category: 'serif',
    subcategories: ['transitional', 'editorial', 'academic'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['academic', 'book', 'editorial', 'reliable'],
    popularity: 94,
    suggestedPairings: ['pt-sans', 'inter'],
    useCases: ['editorial', 'resume', 'website'],
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['variable', 'optical-size', 'modern'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['commercial-type', 'variable', 'editorial', 'google'],
    popularity: 92,
    suggestedPairings: ['roboto', 'roboto-mono'],
    useCases: ['editorial', 'website', 'ui', 'presentation'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['universal', 'transitional', 'reading'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['noto', 'universal', 'book', 'reliable'],
    popularity: 93,
    suggestedPairings: ['noto-sans', 'inter'],
    useCases: ['editorial', 'website', 'presentation'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['didone', 'high-fashion', 'luxury'],
    weights: [400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['luxury', 'fashion', 'bodoni', 'couture'],
    popularity: 91,
    suggestedPairings: ['montserrat', 'raleway'],
    useCases: ['logo', 'branding', 'editorial', 'poster'],
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['old-style', 'humanist', 'literary'],
    ...
    tags: ['garamond', 'classic', 'literature', 'renaissance'],
    popularity: 96,
    suggestedPairings: ['inter', 'karla', 'montserrat'],
    useCases: ['editorial', 'website', 'resume', 'branding'],
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['transitional', 'hebrew', 'literary'],
    weights: [300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['literary', 'hebrew', 'classic', 'noble'],
    popularity: 88,
    suggestedPairings: ['assistant', 'plus-jakarta-sans'],
    useCases: ['editorial', 'website', 'branding'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['old-style', 'garalde', 'book'],
    weights: [400, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['book', 'academic', 'classic', 'gentle'],
    popularity: 92,
    suggestedPairings: ['work-sans', 'inter'],
    useCases: ['editorial', 'resume', 'website'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['old-style', 'variable', 'reading'],
    weights: [200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['variable', 'book', 'refined', 'literature'],
    popularity: 90,
    suggestedPairings: ['dm-sans', 'inter'],
    useCases: ['editorial', 'website', 'resume'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Domine', serif",
    category: 'serif',
    subcategories: ['transitional', 'web-first', 'editorial'],
    weights: [400, 500, 600, 700],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['web-reading', 'sturdy', 'editorial', 'modern'],
    popularity: 89,
    suggestedPairings: ['open-sans', 'karla'],
    useCases: ['website', 'editorial', 'presentation'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Bitter', serif",
    category: 'serif',
    subcategories: ['slab', 'contemporary', 'screen'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['slab-serif', 'editorial', 'screen-reading', 'sturdy'],
    popularity: 93,
    suggestedPairings: ['cabin', 'source-sans-3'],
    useCases: ['editorial', 'website', 'presentation'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['transitional', 'headline', 'dramatic'],
    weights: [400],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['colophon', 'headline', 'dramatic', 'editorial'],
    popularity: 93,
    suggestedPairings: ['dm-sans', 'inter'],
    useCases: ['branding', 'logo', 'editorial', 'poster'],
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['transitional', 'body', 'colophon'],
    weights: [400],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['colophon', 'reading', 'transitional', 'clean'],
    popularity: 90,
    suggestedPairings: ['dm-sans', 'poppins'],
    useCases: ['editorial', 'website', 'resume'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['flared', 'roman', 'classical'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['roman', 'classical', 'inscriptional', 'luxury'],
    popularity: 90,
    suggestedPairings: ['lato', 'montserrat'],
    useCases: ['branding', 'logo', 'poster', 'editorial'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['roman', 'flourished', 'cinematic'],
    weights: [400, 700, 900],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['ornamental', 'swash', 'cinematic', 'epic'],
    popularity: 92,
    suggestedPairings: ['cinzel', 'inter'],
    useCases: ['logo', 'poster', 'gaming', 'branding'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['garamond', 'delicate', 'editorial'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['renaissance', 'delicate', 'luxury', 'poetry'],
    popularity: 91,
    suggestedPairings: ['proza-libre', 'montserrat'],
    useCases: ['editorial', 'branding', 'website'],
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['literary', 'educational', 'refined'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['literary', 'single-story', 'elegant', 'reading'],
    popularity: 87,
    suggestedPairings: ['inter', 'lato'],
    useCases: ['editorial', 'branding', 'presentation'],
    fallback: 'Garamond, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['small-caps', 'monumental', 'classical'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['small-caps', 'monumental', 'badges', 'luxury'],
    popularity: 89,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['logo', 'branding', 'editorial'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['book', 'german', 'sturdy'],
    weights: [400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['german', 'book', 'sturdy', 'reliable'],
    popularity: 90,
    suggestedPairings: ['lato', 'inter'],
    useCases: ['editorial', 'website', 'resume'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['didone', 'high-contrast', 'headline'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['fashion', 'didone', 'extreme-contrast', 'vogue'],
    popularity: 91,
    suggestedPairings: ['montserrat', 'poppins'],
    useCases: ['logo', 'poster', 'social-media', 'branding'],
  ...
  },
  {
    ...
    family: "'Cardo', serif",
    category: 'serif',
    subcategories: ['renaissance', 'humanist', 'scholarly'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['scholarly', 'renaissance', 'classical', 'latin'],
    popularity: 89,
    suggestedPairings: ['karla', 'inter'],
    useCases: ['editorial', 'website', 'presentation'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['editorial', 'newspaper', 'legible'],
    weights: [300, 400, 500, 600, 700, 800],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['newspaper', 'journalism', 'editorial', 'fast'],
    popularity: 87,
    suggestedPairings: ['archivo', 'chivo'],
    useCases: ['editorial', 'website', 'resume'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Besley', serif",
    category: 'serif',
    subcategories: ['clarendon', 'sturdy', 'victorian'],
    weights: [400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['clarendon', 'victorian', 'sturdy', 'historic'],
    popularity: 88,
    suggestedPairings: ['jost', 'inter'],
    useCases: ['branding', 'poster', 'editorial'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['editorial', 'tall', 'delicate'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['boutique', 'luxury', 'tall', 'fashion'],
    popularity: 88,
    suggestedPairings: ['barlow', 'montserrat'],
    useCases: ['branding', 'poster', 'logo', 'editorial'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['didone', 'fashion', 'editorial'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['didone', 'glamour', 'luxury', 'editorial'],
    popularity: 87,
    suggestedPairings: ['lato', 'poppins'],
    useCases: ['branding', 'poster', 'social-media'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['antiqua', 'high-contrast', 'russian'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['antiqua', 'russian', 'editorial', 'dramatic'],
    popularity: 86,
    suggestedPairings: ['open-sans', 'inter'],
    useCases: ['branding', 'poster', 'logo'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['small-caps', 'screen-first', 'production-type'],
    weights: [200, 300, 400, 500, 600, 700, 800],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['small-caps', 'production-type', 'screen', 'elegant'],
    popularity: 88,
    suggestedPairings: ['spectral', 'inter'],
    useCases: ['editorial', 'branding', 'resume'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Forum', serif",
    category: 'serif',
    subcategories: ['roman', 'archaic', 'classical'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['chiseled', 'roman', 'archaic', 'luxury'],
    popularity: 90,
    suggestedPairings: ['montserrat', 'raleway'],
    useCases: ['logo', 'branding', 'poster', 'editorial'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Amiri', serif",
    category: 'serif',
    subcategories: ['naskh', 'arabic', 'calligraphic'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['arabic', 'calligraphic', 'classic', 'naskh'],
    popularity: 91,
    suggestedPairings: ['inter', 'lato'],
    useCases: ['editorial', 'website', 'branding'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Alice', serif",
    category: 'serif',
    subcategories: ['quaint', 'victorian', 'storytelling'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['whimsical', 'storytelling', 'fairytale', 'book'],
    popularity: 89,
    suggestedPairings: ['open-sans', 'quicksand'],
    useCases: ['branding', 'social-media', 'editorial'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['goudy', 'old-style', 'american'],
    weights: [400],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['goudy', 'american', 'classic', 'warm'],
    popularity: 87,
    suggestedPairings: ['lato', 'work-sans'],
    useCases: ['editorial', 'resume', 'website'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['roman', 'monumental', 'classical'],
    weights: [400, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['renaissance', 'classical', 'monumental', 'noble'],
    popularity: 88,
    suggestedPairings: ['quattrocento-sans', 'montserrat'],
    useCases: ['logo', 'branding', 'editorial'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['sinhala', 'transitional', 'refined'],
    weights: [400, 500, 600, 700, 800],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['sinhala', 'refined', 'international', 'clean'],
    popularity: 89,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['editorial', 'website', 'branding'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['dynamic', 'literary', 'contemporary'],
    weights: [400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['award-winning', 'literature', 'rhythmic', 'humanist'],
    popularity: 93,
    suggestedPairings: ['alegreya-sans', 'inter'],
    useCases: ['editorial', 'website', 'presentation', 'resume'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['small-caps', 'literary', 'elegant'],
    ...
    tags: ['small-caps', 'classical', 'literary', 'refined'],
    popularity: 88,
    suggestedPairings: ['alegreya', 'inter'],
    useCases: ['logo', 'editorial', 'branding'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Prata', serif",
    category: 'serif',
    subcategories: ['didone', 'luxury', 'teardrop'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['teardrop', 'luxury', 'lifestyle', 'couture'],
    popularity: 91,
    suggestedPairings: ['montserrat', 'lato'],
    useCases: ['logo', 'branding', 'editorial', 'social-media'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['small-caps', 'high-fashion', 'headline'],
    weights: [400, 700, 900],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['small-caps', 'fashion', 'vogue', 'luxury'],
    popularity: 90,
    suggestedPairings: ['playfair-display', 'inter'],
    useCases: ['logo', 'branding', 'poster'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['korean', 'myeongjo', 'classic'],
    weights: [400, 700, 800],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['korean', 'editorial', 'classic', 'international'],
    popularity: 89,
    suggestedPairings: ['noto-sans-kr', 'inter'],
    useCases: ['editorial', 'website', 'branding'],
    fallback: 'serif',
  ...
  },
  {
    ...
    family: "'Yrsa', serif",
    category: 'serif',
    subcategories: ['editorial', 'rosetta', 'contemporary'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['rosetta', 'contemporary', 'editorial', 'clean'],
    popularity: 87,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['editorial', 'website', 'presentation'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Rasa', serif",
    category: 'serif',
    subcategories: ['gujarati', 'contemporary', 'editorial'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['gujarati', 'editorial', 'contemporary', 'international'],
    popularity: 86,
    suggestedPairings: ['inter', 'karla'],
    useCases: ['editorial', 'website', 'branding'],
    fallback: 'Georgia, serif',
  ...
  // ==========================================
  // SCRIPT, CALLIGRAPHY, AESTHETIC & CURSIVE (45 fonts)
  // (Core for online font generators & social bios)
  // ==========================================
  {
    id: 'sacramento',
    name: 'Sacramento',
    ...
    category: 'script',
    subcategories: ['monoline', 'retro', 'casual'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['aesthetic', 'cursive', 'vintage', 'instagram', 'bio'],
    popularity: 96,
    suggestedPairings: ['montserrat', 'lato'],
    useCases: ['social-media', 'logo', 'branding', 'poster'],
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['brush', 'casual', 'connected'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['brush', 'cursive', 'instagram', 'cafe', 'packaging'],
    popularity: 95,
    suggestedPairings: ['open-sans', 'inter'],
    useCases: ['branding', 'logo', 'social-media', 'poster'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['calligraphy', 'flowing', 'wedding'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['wedding', 'calligraphy', 'luxury', 'elegant', 'cursive'],
    popularity: 96,
    suggestedPairings: ['cormorant-garamond', 'montserrat'],
    useCases: ['branding', 'social-media', 'logo', 'poster'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['french', 'casual', 'chic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['french', 'chic', 'aesthetic', 'cursive', 'fashion'],
    popularity: 94,
    suggestedPairings: ['raleway', 'playfair-display'],
    useCases: ['social-media', 'branding', 'logo'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['brush', '1950s', 'sweet'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['vintage', 'sweet', 'bakery', 'cursive', 'cute'],
    popularity: 92,
    suggestedPairings: ['quicksand', 'nunito'],
    useCases: ['logo', 'social-media', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['flat-brush', 'retro', 'sign-painter'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['sign-painter', 'retro', 'diner', 'baseball', 'bold'],
    popularity: 93,
    suggestedPairings: ['oswald', 'lato'],
    useCases: ['logo', 'poster', 'branding', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['calligraphy', 'feminine', 'stylized'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['signature', 'calligraphy', 'feminine', 'delicate'],
    popularity: 94,
    suggestedPairings: ['lora', 'montserrat'],
    useCases: ['social-media', 'logo', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['italic', 'chancery', 'tall'],
    weights: [400, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['chancery', 'calligraphy', 'delicate', 'poetry'],
    popularity: 91,
    suggestedPairings: ['eb-garamond', 'cormorant-garamond'],
    useCases: ['social-media', 'editorial', 'poster'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['brush', 'dynamic', 'urban'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['urban', 'brush', 'energy', 't-shirt', 'poster'],
    popularity: 93,
    suggestedPairings: ['montserrat', 'open-sans'],
    useCases: ['poster', 'logo', 'social-media', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['casual', 'handwriting', 'organic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['handwriting', 'notes', 'casual', 'organic'],
    popularity: 89,
    suggestedPairings: ['pt-sans', 'inter'],
    useCases: ['social-media', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['felt-pen', 'smooth', 'natural'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['felt-pen', 'signature', 'clean', 'cursive'],
    popularity: 90,
    suggestedPairings: ['lora', 'roboto'],
    useCases: ['social-media', 'branding', 'editorial'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['ballpoint', 'doodle', 'informal'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['doodle', 'scribble', 'notes', 'informal', 'handwritten'],
    popularity: 91,
    suggestedPairings: ['cabin', 'karla'],
    useCases: ['social-media', 'poster', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['monoline', 'pencil', 'recipe'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['recipe', 'pencil', 'authentic', 'nostalgic'],
    popularity: 90,
    suggestedPairings: ['merriweather', 'lato'],
    useCases: ['social-media', 'branding', 'logo'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['cursive', 'authentic', 'school'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['school', 'teacher', 'warm', 'cursive'],
    popularity: 92,
    suggestedPairings: ['open-sans', 'roboto'],
    useCases: ['social-media', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['handwritten', 'casual', 'notes'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['handwritten', 'quotes', 'casual', 'aesthetic'],
    popularity: 93,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['social-media', 'poster', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['neat', 'handwriting', 'clean'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['journal', 'aesthetic', 'bullet-journal', 'feminine'],
    popularity: 95,
    suggestedPairings: ['inter', 'lato'],
    useCases: ['social-media', 'branding', 'logo'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['handwriting', 'balanced', 'quotes'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['quotes', 'neat', 'aesthetic', 'handwritten'],
    popularity: 92,
    suggestedPairings: ['roboto', 'montserrat'],
    useCases: ['social-media', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['bubbly', 'carefree', 'handwritten'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['carefree', 'happy', 'flowers', 'quotes', 'cute'],
    popularity: 97,
    suggestedPairings: ['open-sans', 'quicksand'],
    useCases: ['social-media', 'branding', 'logo', 'poster'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['sharpie', 'street', 'bold'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['sharpie', 'street', 'graffiti', 'bold', 'marker'],
    popularity: 97,
    suggestedPairings: ['oswald', 'roboto'],
    useCases: ['poster', 'social-media', 'logo', 'gaming'],
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['comic', 'fun', 'handwritten'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['youth', 'fun', 'student', 'playful'],
    popularity: 93,
    suggestedPairings: ['nunito', 'inter'],
    useCases: ['social-media', 'poster', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['condensed', 'indie', 'all-caps'],
    weights: [400, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['indie', 'pinterest', 'etsy', 'hand-drawn', 'all-caps'],
    popularity: 98,
    suggestedPairings: ['josefin-sans', 'open-sans'],
    useCases: ['poster', 'social-media', 'logo', 'branding'],
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['grunge', 'felt-marker', 'edgy'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['rock', 'grunge', 'edgy', 'marker', 'album-cover'],
    popularity: 94,
    suggestedPairings: ['roboto', 'montserrat'],
    useCases: ['poster', 'social-media', 'logo', 'gaming'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['devanagari', 'ballpoint', 'smooth'],
    weights: [300, 400, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['devanagari', 'ballpoint', 'authentic', 'friendly'],
    popularity: 93,
    suggestedPairings: ['poppins', 'inter'],
    useCases: ['social-media', 'branding', 'logo'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['brush', 'heavy', 'casual'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['brush', 'bold', 'social', 'casual'],
    popularity: 92,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['social-media', 'poster', 'logo'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['narrow', 'quick', 'sketch'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['sketch', 'pencil', 'fast', 'narrow'],
    popularity: 90,
    suggestedPairings: ['lato', 'roboto'],
    useCases: ['social-media', 'poster'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['korean', 'pen', 'gentle'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['pen', 'travel', 'journal', 'gentle'],
    popularity: 91,
    suggestedPairings: ['inter', 'open-sans'],
    useCases: ['social-media', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['comic', 'felt-pen', 'friendly'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['comic', 'callout', 'friendly', 'felt-pen'],
    popularity: 94,
    suggestedPairings: ['montserrat', 'inter'],
    useCases: ['social-media', 'poster', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['teenage', 'doodle', 'spontaneous'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['teenage', 'spontaneous', 'doodle', 'enthusiastic'],
    popularity: 90,
    suggestedPairings: ['quicksand', 'nunito'],
    useCases: ['social-media', 'poster'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['clean', 'marker', 'humanist'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['marker', 'friendly', 'devanagari', 'clean'],
    popularity: 88,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['social-media', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['whimsical', 'handwritten', 'cyrillic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['nostalgia', 'whimsical', 'warmth', 'cyrillic'],
    popularity: 89,
    suggestedPairings: ['roboto', 'pt-sans'],
    useCases: ['social-media', 'poster', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['photographer', 'watermark', 'cursive'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['watermark', 'signature', 'photography', 'cursive'],
    popularity: 91,
    suggestedPairings: ['montserrat', 'lato'],
    useCases: ['social-media', 'logo', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['foundational', 'calligraphic', 'historic'],
    weights: [400],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['foundational', 'calligraphy', 'johnston', 'historical'],
    popularity: 88,
    suggestedPairings: ['cormorant-garamond', 'lato'],
    useCases: ['editorial', 'branding', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['swash', 'ornate', 'storybook'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['swash', 'storybook', 'fairytale', 'ornate', 'holiday'],
    popularity: 92,
    suggestedPairings: ['playfair-display', 'montserrat'],
    useCases: ['logo', 'branding', 'social-media', 'poster'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['victorian', 'calligraphic', 'formal'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['victorian', 'aristocratic', 'invitation', 'calligraphy'],
    popularity: 90,
    suggestedPairings: ['cormorant-garamond', 'lato'],
    useCases: ['branding', 'logo', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['calligraphy', 'high-slant', 'formal'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['formal', 'italian', 'invitation', 'flourish'],
    popularity: 91,
    suggestedPairings: ['cormorant-garamond', 'montserrat'],
    useCases: ['social-media', 'branding', 'logo'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['romantic', 'french', 'calligraphy'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['romantic', 'perfume', 'french', 'vintage', 'luxury'],
    popularity: 94,
    suggestedPairings: ['bodoni-moda', 'raleway'],
    useCases: ['logo', 'branding', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['ornate', 'swashes', 'historical'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['ornate', 'intricate', 'signature', 'vintage'],
    popularity: 90,
    suggestedPairings: ['playfair-display', 'montserrat'],
    useCases: ['logo', 'branding', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['delicate', 'swashes', 'historic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['historic', 'royal', 'wispy', 'calligraphy'],
    popularity: 89,
    suggestedPairings: ['eb-garamond', 'lato'],
    useCases: ['logo', 'branding', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['sophisticated', 'flowing', 'letters'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['love-letters', 'epistolary', 'elegant', 'cursive'],
    popularity: 90,
    suggestedPairings: ['cormorant-garamond', 'montserrat'],
    useCases: ['social-media', 'branding', 'logo'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['fashion', 'soft', 'glamorous'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['cosmetics', 'lipstick', 'glamour', 'fashion', 'feminine'],
    popularity: 91,
    suggestedPairings: ['bodoni-moda', 'inter'],
    useCases: ['branding', 'logo', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['modern-calligraphy', 'delicate', 'breezy'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['modern-calligraphy', 'whisper', 'delicate', 'aesthetic'],
    popularity: 91,
    suggestedPairings: ['outfit', 'newsreader'],
    useCases: ['social-media', 'branding', 'logo'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['contemporary', 'calligraphic', 'dramatic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['dancing', 'flourish', 'contemporary', 'luxury'],
    popularity: 90,
    suggestedPairings: ['montserrat', 'cormorant-garamond'],
    useCases: ['social-media', 'logo', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['quill', 'charter', 'historic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['quill', 'manuscript', 'parchment', 'historic'],
    popularity: 88,
    suggestedPairings: ['eb-garamond', 'lora'],
    useCases: ['branding', 'poster', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['ornate', 'calligraphic', 'delicate'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['flourishes', 'delicate', 'bios', 'instagram', 'cute'],
    popularity: 89,
    suggestedPairings: ['montserrat', 'inter'],
    useCases: ['social-media', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'script',
    subcategories: ['monoline', 'bouncy', 'playful'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['bouncy', 'monoline', 'casual', 'playful'],
    popularity: 88,
    suggestedPairings: ['poppins', 'quicksand'],
    useCases: ['social-media', 'branding', 'logo'],
    fallback: 'cursive',
  ...
  // ==========================================
  // DISPLAY, RETRO, BOLD, Y2K & POSTER (40 fonts)
  // (Widely searched in text & font generators)
  // ==========================================
  {
    id: 'bebas-neue',
    name: 'Bebas Neue',
    ...
    category: 'display',
    subcategories: ['all-caps', 'condensed', 'headline'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['all-caps', 'condensed', 'youtube', 'poster', 'headline', 'impact'],
    popularity: 99,
    suggestedPairings: ['montserrat', 'inter', 'roboto'],
    useCases: ['poster', 'logo', 'social-media', 'website', 'gaming'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['grotesque', 'heavy', 'headline'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['headline', 'meme', 'heavy', 'advertising', 'impact'],
    popularity: 97,
    suggestedPairings: ['roboto', 'open-sans'],
    useCases: ['poster', 'social-media', 'logo', 'gaming'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['heavy', 'korean', 'block'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['block', 'heavy', 'korean', 'bold', 'punchy'],
    popularity: 93,
    suggestedPairings: ['inter', 'roboto'],
    useCases: ['poster', 'social-media', 'gaming', 'logo'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['comic', 'superhero', 'bold'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['comic', 'superhero', 'marvel', 'punchy', 'gaming'],
    popularity: 96,
    suggestedPairings: ['montserrat', 'open-sans'],
    useCases: ['poster', 'social-media', 'gaming', 'logo'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['racing', 'horizontal-stripes', 'speed'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['racing', 'speed', 'stripes', 'motorsport', 'gaming'],
    popularity: 89,
    suggestedPairings: ['exo-2', 'roboto'],
    useCases: ['gaming', 'logo', 'poster', 'social-media'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['urban', 'vertical', 'signage'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['urban', 'signage', 'all-caps', 'bold', 'retro'],
    popularity: 94,
    suggestedPairings: ['inter', 'roboto-mono'],
    useCases: ['logo', 'poster', 'gaming', 'branding'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    tags: ['3d', 'shadow', 'retro', 'cool', 'fancy'],
    popularity: 92,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['logo', 'poster', 'social-media', 'gaming'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['neon', 'inline', 'arcade'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['neon', 'inline', 'arcade', 'retro', '80s'],
    popularity: 93,
    suggestedPairings: ['space-mono', 'inter'],
    useCases: ['logo', 'poster', 'social-media', 'gaming'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['pixel', '8-bit', 'arcade'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['pixel', '8-bit', 'retro', 'gaming', 'arcade', 'nintendo'],
    popularity: 98,
    suggestedPairings: ['vt323', 'jetbrains-mono'],
    useCases: ['gaming', 'logo', 'social-media', 'tech'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['pixel', 'tiny', 'minimal'],
    weights: [400, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['pixel', 'y2k', 'aesthetic', 'retro', 'gaming'],
    popularity: 94,
    suggestedPairings: ['inter', 'fira-code'],
    useCases: ['gaming', 'tech', 'social-media', 'logo'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['multi-line', 'disco', 'art-deco'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['disco', '70s', 'multi-line', 'neon', 'futuristic'],
    popularity: 95,
    suggestedPairings: ['montserrat', 'inter'],
    useCases: ['logo', 'poster', 'branding', 'social-media'],
    fallback: 'cursive, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['gujarati', 'bold', 'curvaceous'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['bold', 'retro', 'curvaceous', 'food', 'truck-art'],
    popularity: 93,
    suggestedPairings: ['poppins', 'karla'],
    useCases: ['logo', 'poster', 'social-media', 'branding'],
    fallback: 'cursive, sans-serif',
  ...
  },
  {
    ...
    family: "'Ultra', serif",
    category: 'display',
    subcategories: ['wood-type', 'fat-face', 'ultra-bold'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['fat-face', 'heavy', 'poster', 'wood-type', 'bold'],
    popularity: 92,
    suggestedPairings: ['open-sans', 'lato'],
    useCases: ['poster', 'logo', 'social-media', 'branding'],
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['bubbly', 'chubby', 'fun'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['bubbly', 'chubby', 'candy', 'kids', 'happy'],
    popularity: 94,
    suggestedPairings: ['quicksand', 'nunito'],
    useCases: ['logo', 'social-media', 'poster', 'branding'],
    fallback: 'Impact, cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['egyptian', 'heavy-slab', 'athletic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['slab', 'egyptian', 'heavy', 'athletic', 'bold'],
    popularity: 95,
    suggestedPairings: ['roboto', 'open-sans'],
    useCases: ['poster', 'logo', 'branding', 'social-media'],
    fallback: 'Impact, serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['horror', 'halloween', 'slimy'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['horror', 'halloween', 'spooky', 'zombie', 'bloody'],
    popularity: 96,
    suggestedPairings: ['roboto', 'montserrat'],
    useCases: ['poster', 'social-media', 'gaming', 'logo'],
    fallback: 'Impact, cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['typewriter', 'grunge', 'vintage'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['typewriter', 'grunge', 'vintage', 'detective', 'classified'],
    popularity: 95,
    suggestedPairings: ['courier-prime', 'merriweather'],
    useCases: ['poster', 'social-media', 'editorial', 'branding'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    family: "'Rye', serif",
    category: 'display',
    subcategories: ['wild-west', 'western', 'saloon'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['western', 'wild-west', 'cowboy', 'saloon', 'spurs'],
    popularity: 91,
    suggestedPairings: ['open-sans', 'roboto'],
    useCases: ['poster', 'logo', 'social-media'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['circus', 'western', 'wood-type'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['circus', 'vintage', 'carnival', 'victorian'],
    popularity: 88,
    suggestedPairings: ['lato', 'merriweather'],
    useCases: ['poster', 'logo', 'social-media'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['asian-inspired', 'brush-cut', 'origami'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['japanese', 'asian', 'origami', 'samurai', 'martial-arts'],
    popularity: 90,
    suggestedPairings: ['montserrat', 'inter'],
    useCases: ['gaming', 'poster', 'logo', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['tattoo', 'cartoon', 'fun'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['tattoo', 'sailor', 'cartoon', 'whimsical'],
    popularity: 89,
    suggestedPairings: ['quicksand', 'nunito'],
    useCases: ['social-media', 'logo', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['inline', 'tattoo', 'decorative'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['inline', 'tattoo', 'engraved', 'decorative'],
    popularity: 88,
    suggestedPairings: ['inter', 'lato'],
    useCases: ['social-media', 'logo', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['western', 'saloon', 'wood-block'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['western', 'whiskey', 'cowboy', 'rugged', 'wanted-poster'],
    popularity: 90,
    suggestedPairings: ['roboto', 'open-sans'],
    useCases: ['poster', 'logo', 'social-media'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['pirate', 'island', 'windswept'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['pirate', 'treasure', 'island', 'windswept', 'caribbean'],
    popularity: 91,
    suggestedPairings: ['montserrat', 'lato'],
    useCases: ['gaming', 'poster', 'logo', 'social-media'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['sketch', 'chalkboard', 'vintage'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['chalkboard', 'sketch', 'coffeehouse', 'hand-drawn'],
    popularity: 91,
    suggestedPairings: ['open-sans', 'quicksand'],
    useCases: ['poster', 'social-media', 'branding'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['ancient', 'roman', 'chiseled'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['ancient', 'stone', 'chiseled', 'roman', 'mythology'],
    popularity: 89,
    suggestedPairings: ['inter', 'roboto'],
    useCases: ['gaming', 'poster', 'social-media', 'logo'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['urban', 'poster', 'brazilian'],
    ...
    tags: ['street', 'brazil', 'poster', 'playful', 'chubby'],
    popularity: 93,
    suggestedPairings: ['montserrat', 'poppins'],
    useCases: ['poster', 'logo', 'social-media', 'branding'],
    fallback: 'Impact, cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['shadow', '3d', 'street'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['shadow', '3d', 'street-art', 'playful'],
    popularity: 90,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['poster', 'logo', 'social-media'],
    fallback: 'Impact, cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['sketch', 'cross-hatch', 'hand-drawn'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['sketch', 'cross-hatch', 'pencil', 'craft'],
    popularity: 89,
    suggestedPairings: ['lato', 'quicksand'],
    useCases: ['social-media', 'poster', 'branding'],
    fallback: 'cursive',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['cyrillic', 'gothic', 'slavic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['slavic', 'fantasy', 'calligraphy', 'ancient', 'regal'],
    popularity: 88,
    suggestedPairings: ['eb-garamond', 'pt-serif'],
    useCases: ['gaming', 'poster', 'logo', 'branding'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['victorian', 'drop-shadow', 'saloon'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['victorian', 'shadow', 'saloon', 'vintage'],
    popularity: 90,
    suggestedPairings: ['open-sans', 'merriweather'],
    useCases: ['poster', 'logo', 'social-media'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['wireframe', 'y2k', 'experimental'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['y2k', 'cyber', 'experimental', 'wireframe', 'futuristic'],
    popularity: 92,
    suggestedPairings: ['space-mono', 'inter'],
    useCases: ['gaming', 'logo', 'social-media', 'tech'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['stencil', 'cubist', 'abstract'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['cubist', 'stencil', 'abstract', 'brutalist'],
    popularity: 88,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['poster', 'logo', 'branding', 'gaming'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['condensed', 'squarish', 'athletic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['athletic', 'sports', 'condensed', 'squarish', 'bold'],
    popularity: 91,
    suggestedPairings: ['open-sans', 'inter'],
    useCases: ['gaming', 'poster', 'logo', 'social-media'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['experimental', 'abstract', 'minimal'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['experimental', 'avant-garde', 'abstract', 'aesthetic', 'minimal'],
    popularity: 91,
    suggestedPairings: ['inter', 'space-mono'],
    useCases: ['branding', 'logo', 'social-media', 'tech'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['glitch', 'cyberpunk', 'vhs'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['glitch', 'cyberpunk', 'vhs', 'hacker', 'distorted'],
    popularity: 95,
    suggestedPairings: ['jetbrains-mono', 'inter'],
    useCases: ['gaming', 'logo', 'social-media', 'poster'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['grooves', 'retro', 'album'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['vinyl', 'grooves', 'retro', 'music', 'lp'],
    popularity: 91,
    suggestedPairings: ['dm-sans', 'inter'],
    useCases: ['logo', 'poster', 'social-media'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['dripping', 'street', 'graffiti'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['dripping', 'paint', 'street-art', 'fresh', 'gooey'],
    popularity: 93,
    suggestedPairings: ['montserrat', 'poppins'],
    useCases: ['poster', 'social-media', 'gaming', 'logo'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['distressed', 'stamp', 'industrial'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['eroded', 'stamp', 'grunge', 'industrial'],
    popularity: 91,
    suggestedPairings: ['roboto-mono', 'inter'],
    useCases: ['poster', 'gaming', 'social-media'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['bubbles', 'cute', 'inflated'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['bubbles', 'cute', 'soap', 'inflated', 'happy'],
    popularity: 92,
    suggestedPairings: ['quicksand', 'nunito'],
    useCases: ['social-media', 'logo', 'poster', 'branding'],
    fallback: 'sans-serif',
    googleFontQuery: 'Rubik+Bubbles&display=swap',
  },

  // ==========================================
  // MONOSPACE, CODE, RETRO TERMINAL & PIXEL (20 fonts)
  // ==========================================
  {
    id: 'source-code-pro',
    ...
    category: 'monospace',
    subcategories: ['coding', 'adobe', 'terminal'],
    weights: [200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['adobe', 'code', 'terminal', 'programmer', 'clean'],
    popularity: 97,
    suggestedPairings: ['source-sans-3', 'source-serif-4'],
    useCases: ['code', 'tech', 'website', 'ui'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['google', 'clean', 'terminal'],
    ...
    tags: ['google', 'code', 'precise', 'android', 'clean'],
    popularity: 98,
    suggestedPairings: ['roboto', 'roboto-serif'],
    useCases: ['code', 'tech', 'ui', 'website'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['humanist', 'code', 'proportional-spacing'],
    weights: [200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['humanist', 'programmer', 'sublime', 'code'],
    popularity: 96,
    suggestedPairings: ['inter', 'lora'],
    useCases: ['code', 'tech', 'website', 'ui'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['linux', 'terminal', 'canonical'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['linux', 'terminal', 'ubuntu', 'code'],
    popularity: 92,
    suggestedPairings: ['ubuntu', 'inter'],
    useCases: ['code', 'tech', 'website'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['screenplay', 'hollywood', 'classic'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['screenplay', 'hollywood', 'script', 'typewriter', 'cinema'],
    popularity: 94,
    suggestedPairings: ['merriweather', 'inter'],
    useCases: ['editorial', 'code', 'presentation', 'resume'],
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['coding', 'distinguishable', 'crisp'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['code', 'clarity', 'programmer', 'terminal'],
    popularity: 91,
    suggestedPairings: ['proxima-nova', 'inter'],
    useCases: ['code', 'tech', 'website'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['signage', 'technical', 'redhat'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['signage', 'highway', 'code', 'redhat'],
    popularity: 88,
    suggestedPairings: ['overpass', 'lora'],
    useCases: ['code', 'tech', 'website'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['enterprise', 'sysadmin', 'cloud'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['cloud', 'sysadmin', 'terminal', 'clean'],
    popularity: 89,
    suggestedPairings: ['red-hat-display', 'red-hat-text'],
    useCases: ['code', 'tech', 'ui'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['brutalist', 'futuristic', 'dense'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['brutalist', 'ink-traps', 'cyberpunk', 'modern-code'],
    popularity: 91,
    suggestedPairings: ['space-grotesk', 'unbounded'],
    useCases: ['code', 'tech', 'branding', 'gaming'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['cyber', 'hud', 'terminal'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['cyber', 'hud', 'hacker', 'sci-fi', 'terminal'],
    popularity: 93,
    suggestedPairings: ['share-tech', 'orbitron'],
    useCases: ['gaming', 'code', 'tech', 'poster'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['futuristic', 'stylized', 'scifi'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['cyberpunk', 'stylized', 'electronic', 'scifi'],
    popularity: 88,
    suggestedPairings: ['audiowide', 'exo-2'],
    useCases: ['gaming', 'tech', 'logo', 'poster'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['quirky', 'artistic', 'contemporary'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['bohemian', 'artistic', 'quirky', 'experimental'],
    popularity: 90,
    suggestedPairings: ['syne', 'inter'],
    useCases: ['branding', 'tech', 'website', 'poster'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['crt', 'dec-vt220', 'phosphor'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['terminal', 'dec-vt220', 'green-screen', 'retro', 'matrix'],
    popularity: 96,
    suggestedPairings: ['press-start-2p', 'jetbrains-mono'],
    useCases: ['gaming', 'tech', 'social-media', 'code'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['typewriter', 'bookish', 'mechanical'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['typewriter', 'bookish', 'retro', 'literature'],
    popularity: 90,
    suggestedPairings: ['cutive', 'merriweather'],
    useCases: ['editorial', 'code', 'social-media'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['quirky', 'looping-k', 'friendly'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['quirky', 'looping', 'code', 'friendly'],
    popularity: 89,
    suggestedPairings: ['inter', 'quicksand'],
    useCases: ['code', 'tech', 'branding'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    tags: ['kde', 'linux', 'clean', 'code'],
    popularity: 88,
    suggestedPairings: ['oxygen', 'inter'],
    useCases: ['code', 'tech', 'ui'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['grotesque', 'variable', 'contemporary'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['grotesque', 'industrial', 'variable', 'code'],
    popularity: 89,
    suggestedPairings: ['chivo', 'inter'],
    useCases: ['code', 'tech', 'ui', 'editorial'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['swiss', 'helvetica-relative', 'neutral'],
    weights: [400],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['tabular', 'cyrillic', 'forms'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['financial', 'forms', 'cyrillic', 'code'],
    popularity: 87,
    suggestedPairings: ['pt-sans', 'pt-serif'],
    useCases: ['code', 'tech', 'editorial'],
    fallback: 'monospace',
  ...
  },
  {
    ...
    category: 'monospace',
    subcategories: ['aeronautics', 'airbus', 'cockpit'],
    weights: [400, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['airbus', 'cockpit', 'aviation', 'hyper-legible'],
    popularity: 90,
    suggestedPairings: ['b612', 'inter'],
    useCases: ['code', 'tech', 'ui'],
    fallback: 'monospace',
  ...
  // ==========================================
  // TECH, GEOMETRIC, FUTURISTIC & GAMING (20 fonts)
  // ==========================================
  {
    id: 'orbitron',
    name: 'Orbitron',
    ...
    category: 'tech',
    subcategories: ['sci-fi', 'geometric', 'display'],
    weights: [400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['sci-fi', 'spacecraft', 'eurostile', 'gaming', 'tech'],
    popularity: 98,
    suggestedPairings: ['roboto', 'jetbrains-mono'],
    useCases: ['gaming', 'tech', 'logo', 'poster'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['techno', 'wide', 'electronic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['techno', 'electronic', 'wide', 'synthesizer', 'gaming'],
    popularity: 95,
    suggestedPairings: ['exo-2', 'inter'],
    useCases: ['gaming', 'tech', 'logo', 'social-media'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['microgramma', 'wide', 'aerospace'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['microgramma', 'aerospace', 'squarish', 'mid-century-modern'],
    popularity: 93,
    suggestedPairings: ['open-sans', 'inter'],
    useCases: ['tech', 'gaming', 'logo', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['geometric', 'futuristic', 'contemporary'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['futuristic', 'versatile', 'tech', 'gaming', 'ui'],
    popularity: 94,
    suggestedPairings: ['inter', 'roboto-mono'],
    useCases: ['tech', 'gaming', 'ui', 'website'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['geometric', 'tech', 'dynamic'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['kickstarter', 'futuristic', 'tech', 'dynamic'],
    popularity: 91,
    suggestedPairings: ['open-sans', 'lato'],
    useCases: ['tech', 'gaming', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['modular', 'squarish', 'mecha'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['esports', 'mecha', 'squarish', 'gaming', 'scifi'],
    popularity: 96,
    suggestedPairings: ['inter', 'roboto'],
    useCases: ['gaming', 'tech', 'poster', 'logo'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['chamfered', 'industrial', 'thai'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['robotics', 'chamfered', 'military', 'gaming'],
    popularity: 92,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['gaming', 'tech', 'poster', 'logo'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['circuit', 'electronic', 'minimal'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['pcb', 'circuit', 'minimal', 'electronic', 'tech'],
    popularity: 91,
    suggestedPairings: ['roboto', 'montserrat'],
    useCases: ['tech', 'gaming', 'logo', 'website'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['extended', 'wide', 'monumental'],
    weights: [400, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['ultra-wide', 'extended', 'cinematic', 'luxury-tech'],
    popularity: 92,
    suggestedPairings: ['inter', 'lato'],
    useCases: ['logo', 'poster', 'branding', 'social-media'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['kaypro', 'curved-stems', 'scifi'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['microcomputer', 'curved', 'scifi', 'distinct'],
    popularity: 90,
    suggestedPairings: ['inter', 'source-sans-3'],
    useCases: ['tech', 'gaming', 'website'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['versatile', 'esports', 'mechanical'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['esports', 'automotive', 'stadium', 'bold'],
    popularity: 91,
    suggestedPairings: ['inter', 'roboto-mono'],
    useCases: ['gaming', 'poster', 'tech', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['condensed', 'esports', 'hud'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['scoreboard', 'condensed', 'gaming', 'compact'],
    popularity: 90,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['gaming', 'poster', 'social-media'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['stencil', 'military', 'sci-fi'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['stencil', 'spacecraft', 'military', 'industrial', 'gaming'],
    popularity: 89,
    suggestedPairings: ['saira', 'inter'],
    useCases: ['gaming', 'poster', 'logo'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['motorsport', 'speed', 'automotive'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['aerodynamic', 'supercar', 'f1', 'drone', 'automotive'],
    popularity: 89,
    suggestedPairings: ['inter', 'roboto'],
    useCases: ['gaming', 'logo', 'tech', 'poster'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['small-caps', 'motorsport', 'racing'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['small-caps', 'racing', 'badges', 'clan', 'gaming'],
    popularity: 88,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['gaming', 'logo', 'poster'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['block', 'slavic-futurism', 'monumental'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['constructivist', 'heavy', 'soviet', 'gaming', 'poster'],
    popularity: 95,
    suggestedPairings: ['roboto', 'montserrat'],
    useCases: ['gaming', 'poster', 'logo', 'social-media'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['cyberpunk', 'tokyo', 'futuristic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['tokyo', 'neon', 'anime', 'cyberpunk', 'mecha'],
    popularity: 92,
    suggestedPairings: ['inter', 'fira-code'],
    useCases: ['gaming', 'logo', 'poster', 'social-media'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['military', 'stencil', 'heavy'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['tactical', 'military', 'spec-ops', 'call-of-duty', 'stencil'],
    popularity: 94,
    suggestedPairings: ['roboto-mono', 'oswald'],
    useCases: ['gaming', 'poster', 'logo', 'social-media'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['stencil', 'urban', 'rebel'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['stencil', 'graffiti', 'rebel', 'urban'],
    popularity: 88,
    suggestedPairings: ['inter', 'roboto'],
    useCases: ['gaming', 'poster', 'logo'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'tech',
    subcategories: ['sci-fi', 'chamfered', 'clean'],
    weights: [400, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['sleek', 'scifi', 'aerodynamic', 'gaming'],
    popularity: 89,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['gaming', 'tech', 'logo', 'poster'],
    fallback: 'sans-serif',
  ...
  // ==========================================
  // SLAB SERIF & INDUSTRIAL (12 fonts)
  // ==========================================
  {
    id: 'rokkitt',
    name: 'Rokkitt',
    ...
    category: 'slab-serif',
    subcategories: ['geometric-slab', 'display', 'newspaper'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['geometric-slab', 'newspaper', 'bold', 'sturdy'],
    popularity: 92,
    suggestedPairings: ['open-sans', 'inter'],
    useCases: ['editorial', 'poster', 'website', 'branding'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'slab-serif',
    subcategories: ['soft-slab', 'warm', 'editorial'],
    weights: [400],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['warm', 'hospitality', 'editorial', 'teardrop'],
    popularity: 91,
    suggestedPairings: ['lato', 'inter'],
    useCases: ['editorial', 'website', 'branding'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'slab-serif',
    subcategories: ['geometric', '1930s', 'scandinavian'],
    weights: [100, 200, 300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['scandinavian', 'geometric', 'vintage', 'elegant'],
    popularity: 93,
    suggestedPairings: ['josefin-sans', 'lato'],
    useCases: ['branding', 'website', 'poster', 'logo'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'slab-serif',
    subcategories: ['wide', 'slab', 'quirky'],
    ...
    tags: ['wide', 'quirky', 'expressive', 'editorial'],
    popularity: 89,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['editorial', 'branding', 'website'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'slab-serif',
    subcategories: ['ultra-wide', 'display', 'slab'],
    weights: [200, 300, 400, 700, 800],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['ultra-wide', 'display', 'indie', 'poster'],
    popularity: 87,
    suggestedPairings: ['inter', 'karla'],
    useCases: ['poster', 'logo', 'branding'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'slab-serif',
    subcategories: ['horseshoe', 'russian', 'monoline'],
    weights: [400, 500, 600, 700, 800],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['horseshoe', 'monoline', 'distinctive', 'cyrillic'],
    popularity: 88,
    suggestedPairings: ['inter', 'open-sans'],
    useCases: ['branding', 'poster', 'website'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Cutive', serif",
    category: 'slab-serif',
    subcategories: ['typewriter', 'proportional', 'literary'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['typewriter', 'ibm-selectric', 'mechanical', 'book'],
    popularity: 89,
    suggestedPairings: ['cutive-mono', 'merriweather'],
    useCases: ['editorial', 'website', 'resume'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    family: "'Glegoo', serif",
    category: 'slab-serif',
    subcategories: ['modern-egyptian', 'balanced', 'screen'],
    weights: [400, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['egyptian', 'screen', 'news', 'balanced'],
    popularity: 87,
    suggestedPairings: ['lato', 'roboto'],
    useCases: ['website', 'editorial', 'presentation'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'slab-serif',
    subcategories: ['square-slab', 'friendly', 'latin'],
    weights: [400],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['latinotype', 'earthy', 'friendly', 'square-slab'],
    popularity: 90,
    suggestedPairings: ['montserrat', 'open-sans'],
    useCases: ['branding', 'website', 'logo'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'slab-serif',
    subcategories: ['upright-italic', 'friendly', 'branding'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['upright-italic', 'award-winning', 'branding', 'friendly'],
    popularity: 92,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['branding', 'logo', 'website'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'slab-serif',
    subcategories: ['curved-slab', 'warm', 'editorial'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['curved-slab', 'magazine', 'warm', 'latinotype'],
    popularity: 88,
    suggestedPairings: ['open-sans', 'lato'],
    useCases: ['editorial', 'branding', 'website'],
    fallback: 'Georgia, serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['condensed', 'advertising', 'bold'],
    weights: [100, 200, 300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['condensed', 'advertising', 'packaging', 'headline'],
    popularity: 91,
    suggestedPairings: ['lora', 'inter'],
    useCases: ['poster', 'logo', 'social-media'],
    fallback: 'Impact, sans-serif',
  ...
  // ==========================================
  // LUXURY, HIGH-FASHION, GOTHIC & NOVELTY (15 fonts)
  // ==========================================
  {
    id: 'poiret-one',
    name: 'Poiret One',
    ...
    category: 'display',
    subcategories: ['art-deco', 'minimal', 'geometric'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['art-deco', 'paris', 'couture', 'delicate', 'minimal'],
    popularity: 95,
    suggestedPairings: ['montserrat', 'cormorant-garamond'],
    useCases: ['logo', 'branding', 'poster', 'social-media'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'quirky', 'stylized'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal', 'italic'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['quirky-geometric', 'stylish', 'modern', 'branding'],
    popularity: 92,
    suggestedPairings: ['montserrat', 'lora'],
    useCases: ['branding', 'logo', 'website', 'poster'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['geometric', 'vintage', 'fashion'],
    weights: [100, 200, 300, 400, 500, 600, 700],
    styles: ['normal', 'italic'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['1920s', 'geometric', 'fashion', 'vintage'],
    popularity: 96,
    suggestedPairings: ['playfair-display', 'lora'],
    useCases: ['branding', 'logo', 'website', 'presentation'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'sans-serif',
    subcategories: ['high-fashion', 'editorial', 'flared'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['fashion', 'vogue', 'beauty', 'flared', 'runway'],
    popularity: 93,
    suggestedPairings: ['bodoni-moda', 'inter'],
    useCases: ['logo', 'branding', 'editorial', 'social-media'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['art-nouveau', 'slender', 'display'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['art-nouveau', 'slender', 'vienna', 'historic'],
    popularity: 87,
    suggestedPairings: ['cormorant-garamond', 'lato'],
    useCases: ['logo', 'poster', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['tall', 'slender', 'italian'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['italian', 'tall', 'restaurant', 'slender'],
    popularity: 88,
    suggestedPairings: ['montserrat', 'lora'],
    useCases: ['branding', 'logo', 'social-media'],
    fallback: 'cursive, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['minimalist', 'thin-line', 'futuristic'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['minimalist', 'thin', 'futuristic', 'clean'],
    popularity: 89,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['logo', 'tech', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['hyper-condensed', 'headline', 'grotesque'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['hyper-condensed', 'tall', 'headline', 'spine'],
    popularity: 89,
    suggestedPairings: ['lora', 'open-sans'],
    useCases: ['poster', 'editorial', 'logo'],
    fallback: 'Impact, sans-serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['monoline', 'ultra-condensed', 'wire'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['wire', 'neon', 'ultra-condensed', 'monoline'],
    popularity: 87,
    suggestedPairings: ['montserrat', 'inter'],
    useCases: ['logo', 'poster', 'branding'],
    fallback: 'sans-serif',
  ...
  },
  {
    ...
    category: 'serif',
    subcategories: ['upright-italic', 'renaissance', 'calligraphic'],
    weights: [300, 400, 500, 600, 700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['upright-italic', 'unique', 'renaissance', 'poetry'],
    popularity: 89,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['editorial', 'branding', 'logo'],
    fallback: 'Garamond, serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['blackletter', 'gothic', 'fraktur'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['blackletter', 'gothic', 'fraktur', 'tattoo', 'medieval', 'heavy-metal'],
    popularity: 97,
    suggestedPairings: ['eb-garamond', 'inter'],
    useCases: ['logo', 'poster', 'gaming', 'social-media'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['blackletter', 'chancery', 'gothic'],
    weights: [700],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['blackletter', 'tattoo', 'medieval', 'gothic', 'bold'],
    popularity: 95,
    suggestedPairings: ['cormorant-garamond', 'montserrat'],
    useCases: ['logo', 'poster', 'gaming', 'social-media'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['gothic', 'pirate', 'blackletter'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['pirate', 'gothic', 'metal', 'dark-fantasy', 'tattoo'],
    popularity: 93,
    suggestedPairings: ['inter', 'dm-sans'],
    useCases: ['gaming', 'poster', 'logo', 'social-media'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['contemporary-blackletter', 'german', 'variable'],
    weights: [100, 200, 300, 400, 500, 600, 700, 800, 900],
    styles: ['normal'],
    isVariable: true,
    source: 'google-fonts',
    ...
    tags: ['modern-blackletter', 'variable', 'gothic', 'fashion'],
    popularity: 94,
    suggestedPairings: ['inter', 'syne'],
    useCases: ['branding', 'poster', 'social-media', 'logo'],
    fallback: 'serif',
  ...
  },
  {
    ...
    category: 'display',
    subcategories: ['medieval', 'fantasy', 'calligraphy'],
    weights: [400],
    styles: ['normal'],
    isVariable: false,
    source: 'google-fonts',
    ...
    tags: ['dnd', 'fantasy', 'medieval', 'rpg', 'chronicle'],
    popularity: 92,
    suggestedPairings: ['cardo', 'inter'],
    useCases: ['gaming', 'poster', 'logo', 'social-media'],
    fallback: 'serif',
...
console.log(`Prepared ${NEW_POPULAR_FONTS.length} new popular typefaces.`);

// Deduplicate against existing fonts
const newIds = new Set(NEW_POPULAR_FONTS.map((f) => f.id));
const originalBase = TYPEFACES.filter((t) => !newIds.has(t.id));

const combined = [...originalBase, ...NEW_POPULAR_FONTS];
console.log(`Original base fonts: ${originalBase.length}`);
console.log(`New popular fonts: ${NEW_POPULAR_FONTS.length}`);
console.log(`Total font library: ${combined.length} fonts!`);

// Write out the merged font data
const fontsDataPath = path.join(__dirname, '../src/lib/fonts-data.ts');
const fileContent = `import { Typeface, TypefaceCategory, TypefaceUseCase } from './types';

export const TYPEFACES: Typeface[] = ${JSON.stringify(combined, null, 2)};
...
fs.writeFileSync(fontsDataPath, fileContent, 'utf-8');
console.log('Successfully updated src/lib/fonts-data.ts with all fonts and metadata!');
