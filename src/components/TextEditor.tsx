    ...
    <div className={`w-full bg-white border border-zinc-200 rounded-lg p-4 sm:p-5 transition-all ${className}`}>
      ...
      <div className="flex items-center justify-between gap-2 mb-2 text-xs">
        ...
        <div className="flex items-center gap-1">
          <button
            onClick={handleCopy}
            className="px-2 py-1 text-zinc-500 hover:text-zinc-950 rounded transition-colors flex items-center gap-1"
            title="Copy text"
          >
          ...
          <button
            onClick={handleClear}
            className="px-2 py-1 text-zinc-500 hover:text-red-600 rounded transition-colors flex items-center gap-1"
            title="Clear text"
          >
      ...
      <textarea
        ...
        className="w-full text-base sm:text-lg bg-zinc-50/50 border border-zinc-200 rounded-md p-3 text-zinc-950 placeholder:text-zinc-400 focus:outline-none focus:bg-white focus:border-zinc-950 resize-y min-h-[64px] transition-colors"
      />

      {/* Minimal Preset Pills (Smooth touch scroller) */}
      <div className="mt-2.5 scroll-touch-x flex items-center gap-1.5 pb-1 text-xs text-zinc-500">
        <span className="text-[11px] font-mono text-zinc-400 mr-1 uppercase shrink-0">Sample:</span>
